        ...
        <footer className="bg-blue-600 text-white py-6 mt-10">
            <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center md:text-left">
                <div>
                    ...
                    <p className="text-sm">
                        The best place to explore and support local toy sellers.
                        Fun. Safe. Creative. 
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-1 text-sm">
                        ...
                        <li><Link to="/extra">My Toys</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex justify-center md:justify-start gap-3 text-xl">
                        ...
                        <a href="#" className="hover:text-yellow-300">Bal</a>
                        <a href="#" className="hover:text-yellow-300">Number ta ene dis vai</a>
                    </div>
